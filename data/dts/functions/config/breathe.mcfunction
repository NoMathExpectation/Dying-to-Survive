...
scoreboard players set $overworld_breathe_min dtsConfig_bre 40
#define score_holder $overworld_breathe_max
scoreboard players set $overworld_breathe_max dtsConfig_bre 175
...
scoreboard players set $furnace dtsConfig_bre -1

#define score_holder $suffocate
scoreboard players set $suffocate dtsConfig_bre -10
#define score_holder $sprint
scoreboard players set $sprint dtsConfig_bre -20
#define score_holder $jump
scoreboard players set $jump dtsConfig_bre -25
#define score_holder $block_destroy
## 未使用
#define score_holder $clock_destroy
scoreboard players set $block_destroy dtsConfig_bre -25
#define score_holder $block_place
scoreboard players set $block_place dtsConfig_bre -25
