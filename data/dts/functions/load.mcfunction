...
scoreboard objectives add dtsWartPlace1 minecraft.used:minecraft.nether_wart_block
scoreboard objectives add dtsWartPlace2 minecraft.used:minecraft.warped_wart_block
